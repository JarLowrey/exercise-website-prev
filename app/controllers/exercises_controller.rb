class ExercisesController < ApplicationController
  ...
  private
    ...
    def exercise_params
      #params.fetch(:exercise, {:description, :icon_url})

      params.require(:exercise)
            .permit(:description, :icon_url)
    end
