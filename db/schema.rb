...
ActiveRecord::Schema.define(version: 20170630153123) do
  ...
  create_table "event_coaches", force: :cascade do |t|
    ...
    t.index ["user_id", "event_id"], name: "index_event_coaches_on_user_id_and_event_id", unique: true
  ...
  create_table "exercise_instances", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.float "distance"
    t.float "#<ActiveRecord::ConnectionAdapters::SQLite3::TableDefinition:0x00000005558e30>"
  end
